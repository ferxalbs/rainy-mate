...
// Optimization: Define components outside to prevent re-creation on every render.
// This allows react-markdown to reuse internal component instances.
...
// Optimization: Memoize the component to prevent re-renders when content hasn't changed.
// This is critical for chat interfaces where parent components re-render frequently (e.g. on typing).
