...
function MessageBubbleComponent({
  ...
  // Memoize event handlers to preserve referential equality when passed to memoized child components
  // preventing unnecessary re-renders of complex children during token streaming.
...
// Memoized complex child component to avoid tearing down the AST on every streaming token update
