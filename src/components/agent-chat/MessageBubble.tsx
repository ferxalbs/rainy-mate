...
// ⚡ Bolt: Stable empty array reference to prevent breaking React.memo
...
function MessageBubbleComponent({
  ...
  // ⚡ Bolt: Memoize the event handler to ensure a stable function reference
  // is passed to the memoized PlanConfirmationCard, avoiding unnecessary re-renders.
