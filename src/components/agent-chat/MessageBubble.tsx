...
// ⚡ Bolt: Global constant to preserve referential equality across renders for empty fallback arrays.
...
function MessageBubbleComponent({
  ...
  // ⚡ Bolt: Memoize callback to prevent passing new references to PlanConfirmationCard on every render.
