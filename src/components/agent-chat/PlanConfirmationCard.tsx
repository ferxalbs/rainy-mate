...
// Wrapped PlanConfirmationCard in React.memo to prevent unnecessary re-renders
// during fast stream updates in the parent MessageBubble.
// Impact: Reduces React DOM tree reconciliation significantly.
