...
// Performance: Wrapped PlanConfirmationCard in React.memo() to prevent full re-renders
// of tool call lists while the parent chat interface streams new tokens.
