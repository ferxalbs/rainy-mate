...
import type { RegisterProviderRequest } from "../../services/tauri";
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setRegisterForm({ ...registerForm, api_key: e.target.value })
                }
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
              />
            </div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div>
                      ...
                      <span
                        className={`font-medium ${getHealthColor(provider.health)}`}
                      >
                        {provider.health}
                      </span>
                    </div>
                ...
                <div className="flex flex-col gap-2 ml-4">
                  ...
                  <button
                    ...
                    className="px-3 py-1 bg-gray-500 text-white text-sm rounded hover:bg-gray-600 opacity-50 cursor-not-allowed"
