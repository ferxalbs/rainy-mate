...
// Move plugins and components outside of the render function to prevent
// referential inequality on every render. This prevents React-Markdown
// from tearing down and rebuilding the entire AST when streaming tokens.
