...
// ⚡ Bolt: Define static props outside the component to prevent referential inequality
// on every render. This avoids complete AST teardown and re-parsing in react-markdown,
// especially critical during chat streaming.
...
// ⚡ Bolt: Wrap MarkdownRenderer in React.memo to prevent unnecessary re-renders
// when parent component state changes but content/className props remain the same.
